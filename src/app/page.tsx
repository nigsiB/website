    ...
    <main>
      <section className="px-6 py-16 md:px-12 md:py-28">
        <div className="mx-auto w-full max-w-6xl">
          ...
          <h1 className="mt-3 max-w-4xl text-6xl leading-[0.9] md:text-8xl">MULTIDISCIPLINARY DESIGN THAT SHIPS.</h1>
        ...
        <div className="mx-auto w-full max-w-6xl rounded-sm border border-black/10 bg-white p-5 md:p-7">
          <div className="invert-dots flex flex-col gap-6 border border-black/15 p-6 md:flex-row md:items-end md:justify-between md:p-8">
            <div>
              ...
              <h2 className="mt-3 max-w-3xl text-4xl leading-tight text-black md:text-6xl">Let&apos;s build your next project.</h2>
